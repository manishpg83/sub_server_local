...
#page{width:100%;padding:0;width:640px;margin:0 auto;}
...
<div id="d16" class="dchk"><input type="checkbox"  id="c16" class="chk" name="c16" value="16" onclick="ck(16)" $checked[16] />&#x2002;inching</div>
...
</fieldset><input type="submit" class="btn" /></div></form>
</div></div>
  ...
  for (var div=0; div<divs.length; div++){
    ...
    if (did != null){
      if (did.substring(0,1) == "d"){
        var i = parseInt(did.substring(1,3));
