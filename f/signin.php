...
<p>Your general allergy clinical history and dietary food selections will be analyzed by Allermetrix statistical data software. Your doctor will review the summary, along with your clinical symptoms, and then choose the appropriate tests to be conducted.</p>
</div>
EOT;
...
<br>Pass Code <span id="autofill">(From your healthcare provider)</span>: <br><input $lclass type="text" name="code" value="$code" required /><span class="red"> *</span><br>
