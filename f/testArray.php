...
echo <<<EOT
<!DOCTYPE html><html lang="en"><head><title>Test Array</title><style>
...
var colors = {0:[null,null]};
//var colors = {10:['#ff0','#ff0'],30:['#0ff','#0ff']};
//var border = {10:['#ff0','#ff0'],30:['#ff0','#f00']};
var colors = {10:['#ff0'],30:['#0ff']};
var border = {10:['#ff0','#f00'],30:['#0ff','#f00']};


//var convert{1:[false,picks],10:[false,true]'};
//var color = convert[1][1][1];
...
function ck(id){
  ...
  console.log('checkBoxes, after ck');
  console.log(checkBoxes);
}
...
function init(){
  for (var id in checkBoxes){
   ...
   // border[10][Number(checkBoxes[id][2].checked)];
