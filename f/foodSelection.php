...
<!DOCTYPE html><html lang="en"><head><title>Food Selections</title><style>

body { font-family : arial; border : 0; padding : 0; margin : 0; } 
#logo { margin : 0 auto 0; }
#content { max-width : 640px; margin : 0 auto 0; padding :0; }
...
<div id="s13">
<p class="bold center red">When finished click the "Next" button to post to your selections to your physician</p>
...
<p>&bull; Clinical studies indicate you are most likely allergic to foods you eat often.</p>
<p>&bull; When finished, select the "Next" button.<br></p>
</div>
<p class="bold center red">Check ONLY foods you eat AT LEAST THREE TIMES per week.</p>
