...
<style type="text/css">body{background-color:#FFBF00;color:#008;}.ckbx{margin:0;padding:0;}
#col {
  columns: 100px 4;
}
</style></head>
...
$sql = "SELECT `Code`,`description` FROM `Rast` WHERE `Code` LIKE 'W%' ORDER BY `Rast`.`description` ASC";
...
<input type="hidden" name="grp" value="weed"/>
</form>
