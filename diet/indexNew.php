    ...
    if (strlen($error) == 0 AND $rows == 1){
      ...
      if (strlen($error) != 0 || $rows != 1){
        ...
        if (strlen($error) != 0 || $rows != 1){
          ...
          $results = @mysql_query($sql);
          list($clientx, $Patient, $CutOffE, $CutOffG4, $excludeMethod, $CrossreactivityGrocery, $CrossreactivityDiet, $CrossreactivityPhycian, $CrossreactivityPatient, $HiddenFoodPhysician, $HiddenFoodPatient, $ExcludeIgE, $ExcludeIgG, $ExcludeIgG4) =  mysql_fetch_array($results, MYSQL_NUM);
          ...
          list($clientx, $Patient, $CutOffE, $CutOffG4, $excludeMethod, $CrossreactivityGrocery, $CrossreactivityDiet, $CrossreactivityPhycian, $CrossreactivityPatient, $HiddenFoodPhysician, $HiddenFoodPatient, $ExcludeIgE, $ExcludeIgG, $ExcludeIgG4) = mysql_fetch_array($results, MYSQL_BOTH);
        }
