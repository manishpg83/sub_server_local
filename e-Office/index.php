...
if($sub == 60){
  ...
  file_put_contents('/home/amx/public_html/e-office/done.txt',"$code|$client");
  header("Location: https://amxemr.com/enter.php?Accession=$code");
  exit;
}
...
if($sub == 55){include('/home/amx/public_html/e-office/profile.php');exit;}
if($sub == 56){include('/home/amx/public_html/e-office/profile.php');exit;}
if($sub == 51){
  if($testpath){include('/home/amx/public_html/e-office/requestTest.php');exit;}
  include('/home/amx/public_html/e-office/request.php');exit;
}
if($sub == 52){include('/home/amx/public_html/e-office/printRequest.php');exit;}
if($sub == 57){
  if($phone > 0 && strlen($phone) != 10){$err = 1;include('/home/amx/public_html/e-office/profile.php');exit;}
  include('/home/amx/public_html/e-office/panels.php');exit;
}
if($sub == 41){include('/home/amx/public_html/e-office/selections.php');exit;}
if($sub == 50){include('/home/amx/public_html/e-office/selections.php');exit;}
if($sub == 70){include('/home/amx/public_html/e-office/selections.php');exit;}


if($sub == 40){$lookuplast = '';include('/home/amx/public_html/e-office/addon.php');exit;}
if($sub == 53){include('/home/amx/public_html/e-office/addon.php');exit;}
if($sub == 58){
  $icd = trim($_POST['icd']);
  ...
  if($testpath){include('/home/amx/public_html/e-office/requestTest.php');exit;}
  include('/home/amx/public_html/e-office/request.php');
  exit;
}
