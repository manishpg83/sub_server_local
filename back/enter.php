...
if ($sub == 0){
  ...
  if ($id < 100000){header("Location: https://amxemr.com");exit;} 
  setcookie("amxc", $id,time()+3600,'/');
  if ($sub == 4){
    $name = $_POST['name'];
  }
...
.divCheck,.divNoCheck{font-weight:700;color:#fff;width:44px;display:inline-block;padding:4px 2px 6px 4px;margin:0 0 0 0;vertical-align: middle;position: relative;}
.check,.nocheck{color:#fff;display:inline;padding:6px 0 6px 6px;margin-bottom:6px;outline:2px solid #000;}
.divNoCheck{background:#66cccc;}
.nocheck{background:#66cccc;}
...
.v5{color:#ff0;}
.c5{color:#3bf;}
.h1,.h2,.h3,.h4,.h5,.h6,#sub,#lo,#ss,#ph,#clear,#order,#announce,#close,#fh{font-weight:700;border:0;padding:0;margin:0;color:#fff;background:#66CCCC;
...
#sub,#lo,#ss,#ph,#clear,#order,.box,#announce,#close,#fh{border:2px ridge #6cc;margin-top:4px;}
...
h2{margin-bottom:0;}
#sub,#lo,#ss,#ph,#clear,#order,#announce,#close,#fh{width:100%;font:700 1em Arial,sans-serif;padding:.25em;}
...
var bg = new Array('#66cccc','#f00');var div = 0;var c = new Array(8);var d = new Array(8);
