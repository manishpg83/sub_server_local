...
<div id="d003"><input id="c1" type="radio"  name="billing" value="1"  $checked[1] onchange="chkAll()"  required />&#x2002;
Bill Client </div><div id="s003"></div> 

<div id="d004" ><input id="c2" type="radio"  name="billing" value="2"  $checked[2]  onchange="chkAll()" />&#x2002;
Bill Medicare</div><div id="s004"></div>

<div id="d005"><input id="c3" type="radio" name="billing" value="3"   $checked[3] onchange="chkAll()" />&#x2002;
Bill Medcaid </div><div id="s005"></div> 

<div id="d006"><input id="c4" type="radio"  name="billing" value="4"   $checked[4] onchange="chkAll()" />&#x2002;
Bill Patient</div><div id="s006"></div>

<div id="d007"><input id="c5" type="radio" name="billing" value="5"   $checked[5] onchange="chkAll()"/>&#x2002;
...
eMail: <br><input class="email" name="email" type="text" value="$email"  autocomplete="off"/><br>
</div>
