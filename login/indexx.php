...
if($sub == 55){include('/home/amx/public_html/login/profile221218.php');exit;}
if($sub == 56){include('/home/amx/public_html/login/profile221218.php');exit;}
if($sub == 51){
  if($testpath){include('/home/amx/public_html/login/requestTest.php');exit;}
  include('/home/amx/public_html/login/request.php');exit;
}
if($sub == 52){include('/home/amx/public_html/login/printRequest.php');exit;}
if($sub == 57){
  if($phone > 0 && strlen($phone) != 10){$err = 1;include('/home/amx/public_html/login/profile.php');exit;}
  include('/home/amx/public_html/login/panels.php');exit;
}
if($sub == 41){include('/home/amx/public_html/login/selections.php');exit;}
if($sub == 50){include('/home/amx/public_html/login/selections.php');exit;}
if($sub == 70){include('/home/amx/public_html/login/selections.php');exit;}


if($sub == 40){$lookuplast = '';include('/home/amx/public_html/login/addon.php');exit;}
if($sub == 53){include('/home/amx/public_html/login/addonx.php');exit;}
if($sub == 58){
  $icd = trim($_POST['icd']);
  ...
  if($testpath){include('/home/amx/public_html/login/requestTest.php');exit;}
  include('/home/amx/public_html/login/request.php');
  exit;
}
