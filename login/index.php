...
if($sub == 55){include('/home/amx/public_html/login/profile.php');exit;}
if($sub == 56){include('/home/amx/public_html/login/profile.php');exit;}
if($sub == 51){
...
if($sub == 53){include('/home/amx/public_html/login/addon.php');exit;}
if($sub == 58){
  $icd = trim($_POST['icd']);
