...
#lo,#fh,#oo,#clear,#sub,.c5,#close,#abne,#abng{background-image: linear-gradient(to bottom, rgba(0,0,180,1) 0%, rgba(0,0,30,1) 100%);}
#abne,#abng{width:49.6%;font:700 1.1em Arial,sans-serif;color:#fff;margin:4px 0 4px;height:40px;}
.hide{display:none;}
...
<button id="abne"  onclick="document.getElementById('abnE').contentWindow.print()">Print IgE ABN</button>
<button id="abng"  onclick="document.getElementById('abnG').contentWindow.print()">Print IgG/IgG<sub>4</sub> ABN</button>
$history
$orderbutton
</div>
