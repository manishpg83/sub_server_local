...
<div id="page">
<form style="display:inline-block;" action="https://amxemr.com/f/" method="post"><div>
...
<td><form action="https://amxemr.com/f/" method="post"><input type="hidden" name="rec" value="$rec" /><input type="hidden" name="sub" value="4" />
