...
<form action="history.php" method="post"><div>
EOT;
ob_flush();
$checkbox = array();
$checkbox[1] = 'mother';
...
foreach($_POST as $k => $v){
  $type = substr($k,0,1);
  if($type == 'c'){$checked[$v] = 'checked="checked"';}
  $show .= "$checkbox[$v]<br/>\n";
  $sql .= "chk$v=1,";
}
echo <<<EOT
...
<div id="d65" class="dchk"><input type="checkbox"  id="c65" class="chk" name="c65" value="65" onclick="ck(65)" $checked[65] />&#x2002;January</div>
<div id="d68" class="dchk"><input type="checkbox"  id="c68" class="chk" name="c68" value="68" onclick="ck(68)" $checked[68] />&#x2002;April</div>
<div id="d71" class="dchk"><input type="checkbox"  id="c71" class="chk" name="c71" value="71" onclick="ck(71)" $checked[71] />&#x2002;July</div>
<div id="d74" class="dchk"><input type="checkbox"  id="c74" class="chk" name="c74" value="74" onclick="ck(74)" $checked[74] />&#x2002;October</div>
<div id="d66" class="dchk"><input type="checkbox"  id="c66" class="chk" name="c66" value="66" onclick="ck(66)" $checked[66] />&#x2002;February</div>
<div id="d69" class="dchk"><input type="checkbox"  id="c69" class="chk" name="c69" value="69" onclick="ck(69)" $checked[69] />&#x2002;May</div>
<div id="d72" class="dchk"><input type="checkbox"  id="c72" class="chk" name="c72" value="72" onclick="ck(72)" $checked[72] />&#x2002;August</div>
<div id="d75" class="dchk"><input type="checkbox"  id="c75" class="chk" name="c75" value="75" onclick="ck(75)" $checked[75] />&#x2002;November</div>
<div id="d67" class="dchk"><input type="checkbox"  id="c67" class="chk" name="c67" value="67" onclick="ck(67)" $checked[67] />&#x2002;March</div>
<div id="d70" class="dchk"><input type="checkbox"  id="c70" class="chk" name="c70" value="70" onclick="ck(70)" $checked[70] />&#x2002;June</div>
<div id="d73" class="dchk"><input type="checkbox"  id="c73" class="chk" name="c73" value="73" onclick="ck(73)" $checked[73] />&#x2002;September</div>
<div id="d76" class="dchk"><input type="checkbox"  id="c76" class="chk" name="c76" value="76" onclick="ck(76)" $checked[76] />&#x2002;December</div>
...
<div id="d92" class="dchk"><input type="checkbox"  id="c92" class="chk" name="c92" value="92" onclick="ck(92)" $checked[92] />&#x2002; pigeon</div></div>
<input type="submit" class="btn value="submit" /></div><div class="summary">$show</div></form>
<form action="f.php" method="post"><button class="go" type="submit">Foods</button></form></div><div id="s888"></div>
