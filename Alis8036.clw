...
CreatePDF  ROUTINE
 ...
 !~    stop(CLIP(gloReportFileName) & locFileName)
  ...
  !   stop(PR:Invoice & ' - ' & PR:Client)
    ...
    ADD(WebPage)
      SHARE(TEST)
      WP:Text = '<form action="https://www.amxemr.com/cpl/alisReview.php" method="post">'
      ADD(WebPage)
...
Report               REPORT('Results'),AT(250,3600,8000,7000),PRE(RPT),FONT('Arial',10),THOUS
  ...
  TRN
                         STRING('Teléfono: 615-599-4100'),AT(6271,719,1458,156),USE(?String44),FONT('Arial',8,,FONT:regular), |
  TRN
  ...
  TRN
                         ...
                         STRING('Fecha De Colección'),AT(2313,2521),USE(?String35),FONT('Arial',8,,FONT:underline), |
  TRN
  ...
  TRN
                         STRING('# De Identificación'),AT(3833,2146,1146,188),USE(?String30),FONT('Arial',8,,FONT:underline), |
  CENTER,TRN
...
Equivocal              DETAIL,AT(10,,8302,240)
  ...
  CENTER,TRN
                         STRING('Equívoco'),AT(1760,63,677,219),USE(?Equivocal:3),FONT(,10,COLOR:Black,FONT:bold,CHARSET:ANSI), |
  CENTER,TRN
...
TEquivocal             DETAIL,AT(10,,8302,240)
  ...
  CHARSET:ANSI),CENTER,TRN
                         ...
                         STRING('Equívoco'),AT(1760,63,677,219),USE(?Equivocal:2),FONT(,10,COLOR:Black,FONT:bold,CHARSET:ANSI), |
  CENTER,TRN
...
EInterp                DETAIL,AT(10,10,8302,2219)
  ...
  CENTER,TRN
                         ...
                         STRING('Equívoco'),AT(2990,771,2365,208),USE(?StringEinterp2:3),FONT(,10,COLOR:Black,FONT:bold, |
  CHARSET:ANSI),CENTER,TRN
  ...
  CENTER,TRN
                         ...
                         STRING('Ningún Anticuerpo Detectado'),AT(2990,563,2365,208),USE(?StringEinterp1),FONT(,10, |
  COLOR:Black,FONT:bold,CHARSET:ANSI),CENTER,TRN
  ...
  CENTER,TRN
                         STRING('Resultados IgE Específicos'),AT(438,31,2063,208),USE(?locHeading:5),FONT(,10,COLOR:White, |
  FONT:bold,CHARSET:ANSI),CENTER,COLOR(COLOR:Black),TRN
                         STRING('Interpretación'),AT(3031,302,2240,208),USE(?RES:Description:9),FONT(,10,COLOR:White, |
...
G4Interp               DETAIL,AT(10,10,8302,2219)
  ...
  CENTER,TRN
                         ...
                         STRING('Equívoco'),AT(2990,771,2365,208),USE(?StringEinterp2:2),FONT(,10,COLOR:Black,FONT:bold, |
  CHARSET:ANSI),CENTER,TRN
                         STRING('0/1'),AT(5688,752,313,208),USE(?StringEinterpClass2),FONT(,10,,FONT:bold,CHARSET:ANSI), |
  CENTER,TRN
  ...
  COLOR:Black,FONT:bold,CHARSET:ANSI),CENTER,TRN
                         ...
                         STRING('0'),AT(5688,552,313,208),USE(?StringEinterpClass1),FONT(,10,,FONT:bold,CHARSET:ANSI), |
  CENTER,TRN
                         STRING('Resultados IgG4 Específicos'),AT(438,31,2063,208),USE(?locHeading:9),FONT(,10,COLOR:White, |
  FONT:bold,CHARSET:ANSI),CENTER,COLOR(COLOR:Black),TRN
                         STRING('Interpretación'),AT(3031,302,2240,208),USE(?RES:Description:9),FONT(,10,COLOR:White, |
  FONT:bold,CHARSET:ANSI),CENTER,TRN
                         STRING('Clase'),AT(5677,313),USE(?RES:Score:8),FONT(,10,COLOR:White,FONT:bold,CHARSET:ANSI), |
  CENTER,TRN
                         STRING('Conc (µg/mL)'),AT(6156,333,875,208),USE(?String72:7),FONT(,10,COLOR:White,FONT:bold, |
  CHARSET:ANSI),CENTER,TRN
                       END
GInterp                DETAIL,AT(10,10,8302,2219)
  ...
  COLOR:Black,FONT:bold,CHARSET:ANSI),CENTER,TRN
                         ...
                         STRING('0'),AT(5688,552,313,208),USE(?StringEinterpClass1),FONT(,10,,FONT:bold,CHARSET:ANSI), |
  CENTER,TRN
                         STRING('Resultados IgG Específicos'),AT(438,31,2063,208),USE(?locHeading:10),FONT(,10,COLOR:White, |
  FONT:bold,CHARSET:ANSI),CENTER,COLOR(COLOR:Black),TRN
                         STRING('Interpretación'),AT(3031,302,2240,208),USE(?RES:Description:9),FONT(,10,COLOR:White, |
  FONT:bold,CHARSET:ANSI),CENTER,TRN
                         STRING('Clase'),AT(5677,313),USE(?RES:Score:8),FONT(,10,COLOR:White,FONT:bold,CHARSET:ANSI), |
  CENTER,TRN
                         STRING('Conc (µg/mL)'),AT(6156,333,875,208),USE(?String72:3),FONT(,10,COLOR:White,FONT:bold, |
  CHARSET:ANSI),CENTER,TRN
                       END
TInterp                DETAIL,AT(-313,10,8302,2219)
  ...
  FONT:bold,CHARSET:ANSI),CENTER,COLOR(COLOR:Black),TRN
                         STRING('Edad (Años)'),AT(3031,354,2240,208),USE(?RES:Description:10),FONT(,10,COLOR:White, |
  FONT:bold,CHARSET:ANSI),CENTER,TRN
...
GInterpx               DETAIL,AT(10,10,8302,1229)
                         ...
                         STRING('Equívoco'),AT(2990,771,2365,208),USE(?StringEinterp2),FONT(,10,COLOR:Black,FONT:bold, |
  CHARSET:ANSI),CENTER,TRN
  ...
  CENTER,TRN
                         STRING('Resultados IgG4 Específicos'),AT(490,52,2135,208),USE(?locHeading:6),FONT(,10,COLOR:White, |
  FONT:bold,CHARSET:ANSI),CENTER,COLOR(COLOR:Black),TRN
                         STRING('Interpretación'),AT(2969,302,2281,208),USE(?RES:Description:8),FONT(,10,COLOR:White, |
  FONT:bold,CHARSET:ANSI),CENTER,TRN
...
PElevated              DETAIL,AT(10,10,8302,240)
  ...
  TRN
                         STRING('Director del Laboratorio Médico'),AT(52,125,1656,188),USE(?String40:2),FONT('Arial', |
  8,,FONT:regular),TRN
...
! ___________________________________________________________________
    ...
    IF locSummary
      ...
      locPatientText = 'Los resultados del laboratorio necesitan ser correlacionados a su historia clinica y síntomas clínicos antes de cualquier diagnosis.  Una prueba positive puede o no puede indicar una condición alérgica y solamente su medico puede hacer esa determinación.  La información de la evitación presentada en este informe no constituye consejo medico y es para su información de character general solamente.  Consulte con el doctor si usted tiene algunas preocupaciones o preguntas especificas con respecto a la información.'
      gloReportTitle = 'Resumen Del Paciente'
      PRINT(RPT:PatientInfo)
      SAV:Code = 'x'
      SAV:Sort = 9

      gloReportTitle = 'Información Del Patiente'
...
G4Interp               DETAIL,AT(10,100,8302,2198),USE(?DETAIL3)
  ...
  CENTER,TRN
                         STRING('Conc (µg/mL)'),AT(5437,375,885,208),USE(?S72:11),FONT(,10,COLOR:White,FONT:bold,CHARSET:ANSI), |
  CENTER,TRN
                       END
GInterp                DETAIL,AT(10,100,8302,2250),USE(?DETAIL4)
  ...
  CENTER,TRN
                         STRING('Conc (µg/mL)'),AT(5448,365,896,167),USE(?S72:2),FONT(,10,COLOR:White,FONT:bold,CHARSET:ANSI), |
  CENTER,TRN
                       END
...
Covid                  DETAIL,AT(0,0,8000,7552),USE(?DETAIL35:2),FONT(,,,FONT:bold)
  ...
  TRN
                         ...
                         STRING('165.1 µg/mL'),AT(448,979,1583,219),USE(?StringConcValue1),FONT(,,COLOR:White),CENTER, |
  HIDE,TRN
                         STRING('165.1 µg/mL'),AT(2823,979,1583,219),USE(?StringConcValue2),FONT(,,COLOR:White),CENTER, |
  HIDE,TRN
                         STRING('165.1 µg/mL'),AT(5240,979,1583,219),USE(?StringConcValue3),FONT(,,COLOR:White),CENTER, |
  HIDE,TRN
...
GInterp                DETAIL,AT(10,0,8302,2250),USE(?DETAIL4)
  ...
  CENTER,TRN
                         STRING('Conc (µg/mL)'),AT(6198,354,896,167),USE(?S72:2),FONT(,10,COLOR:White,FONT:bold,CHARSET:ANSI), |
  CENTER,TRN
                       END
VgInterp               DETAIL,AT(10,0,8292,5146),USE(?DETAIL4:2)
  ...
  CENTER,TRN
                         STRING('Conc (µg/mL)'),AT(5677,323,1052,167),USE(?S72),FONT(,10,COLOR:White,FONT:bold,CHARSET:ANSI), |
  CENTER,TRN
  ...
  CENTER,TRN
                         STRING('Conc (µg/mL)'),AT(5687,1490,1052,167),USE(?S72:16),FONT(,10,COLOR:White,FONT:bold, |
  CHARSET:ANSI),CENTER,TRN
  ...
  CENTER,TRN
                         STRING('Conc (µg/mL)'),AT(5635,2677,1052,167),USE(?S72:18),FONT(,10,COLOR:White,FONT:bold, |
  CHARSET:ANSI),CENTER,TRN
...
CovSubHeading          DETAIL,AT(10,10,8302,229),USE(?CovSubHeading)
  ...
  CENTER,TRN
                         STRING('Conc (µg/mL)'),AT(5083,20,1115,219),USE(?S72:13),FONT(,10,COLOR:White,FONT:bold,CHARSET:ANSI), |
  CENTER,TRN
...
SkipDetails BYTE
  ...
  !  stop(i# & ', CODE:' & RES:Code & ', CONC: ' & RES:Conc & ', ' & RES:Percentile & '%, ARROW XPOS:' & (1125 + (RES:Percentile/100 * (2800 - 1125))))            
   ...
   !  stop(i# & ', CODE:' & RES:Code & ', CONC: ' & RES:Conc & ', ' & RES:Percentile & '%, ARROW XPOS:' & (1125 + (RES:Percentile/100 * (2800 - 1125))))            
    ...
    gloReportTitle = 'Summary'
    PRINT(RPT:COVID) 
    locInturpt[7,1] = '< 0.38 µg/mL'
    locInturpt[7,3] = '>= 0.38 µg/mL'
    locInturpt[7,2] = '>= 2.10 µg/mL'
    locInturpt[8,1] = '< 0.50 µg/mL'
    locInturpt[8,3] = '>= 0.50 µg/mL'
    locInturpt[8,2] = '>= 0.87 µg/mL'
