...
#AT (%BeginningExports)
  #IF (%ProgramExtension='DLL')
    #IF (%WebCategoryLinkMode)
      ...
      #CALL(%AddExpItem(ABC),'ABLPROP$CreateBoolValue')
      #CALL(%AddExpItem(ABC),'ABLPROP$CreateIntegerValue')
      #CALL(%AddExpItem(ABC),'ABLPROP$CreateStringValue')
      #CALL(%AddExpItem(ABC),'ABLPROP$CREATEREFERENCEVALUE')
      #CALL(%AddExpItem(ABC),'ABLPROP$CREATECVALUE')
      #CALL(%AddExpItem(ABC),'ABLPROP$CreateValue')
    #ENDIF
  #ENDIF
#ENDAT
#!
