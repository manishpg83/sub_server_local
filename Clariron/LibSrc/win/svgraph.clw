...
GraphTextClass.SetFont              procedure(<string parFontName>, <long parFontSize>, |
 ...
 code
  if ~omitted(parFontName)  then self.eFontName  = parFontName end
  if ~omitted(parFontSize)  then self.eFontSize  = parFontSize end
  if ~omitted(parFontColor) then self.eFontColor = parFontColor end
  if ~omitted(parFontStyle) then self.eFontStyle = parFontStyle end
  if ~omitted(parCharSet)   then self.eCharSet   = parCharSet end
!
GraphTextClass.SetBgr               procedure(<long parColor>, <long parColor2>, <long parStyle>)
 code
  if ~omitted(parColor)  then self.gBgr.eColor = parColor end
  if ~omitted(parColor2) then self.gBgr.eColor2 = parColor2 end
  if ~omitted(parStyle)  then self.gBgr.eStyle = parStyle end
!
...
GraphTextClass.SetRectangle         procedure(<real parX>, <real parY>, <real parW>, <real parH>)
 code
  if ~omitted(parX) then self.eX = parX end
  if ~omitted(parY) then self.eY = parY end
  if ~omitted(parW) then self.eW = parW end
  if ~omitted(parH) then self.eH = parH end
!
...
GraphNodeClass.SetRectangle         procedure(<real parX>, <real parY>, <real parW>, <real parH>)
 code
  if ~omitted(parX) then self.gRec.eX = parX end
  if ~omitted(parY) then self.gRec.eY = parY end
  if ~omitted(parW) then self.gRec.eW = parW end
  if ~omitted(parH) then self.gRec.eH = parH end
!
...
GraphNodeClass.Draw                 procedure
 code
  ...
  if self.iNode.IsNullPar(self.qNode) then return end
  case self.eType
  of NodeType:None                                  ! Invisible
...
lq                  qPieType
 code
  if self.iDiagram.IsNullPar(self.qGraph.qNode) then return end
  self.iDiagram.Set(self.qGraph.qNode)
  loop until self.iDiagram.Next(self.qGraph.qNode)  ! Cycle through the nodes
    lq.eSlice = abs(self.iDiagram.AToLY(self.qGraph.qNode.gXY.eY))
...
GraphPieClass.CalcSliceSum          procedure
 code
  clear(self.eSliceSum)
  self.iDiagram.Set(self.qGraph.qNode)
  loop until self.iDiagram.Next(self.qGraph.qNode)
    self.eSliceSum += abs(self.iDiagram.AToLY(self.qGraph.qNode.gXY.eY))
  end
!
...
locAlpha      real, auto
 code
  locLY = abs(self.iDiagram.AToLY(self.qGraph.qNode.gXY.eY))
  if self.eSliceSum <> 0
  ...
  self.qGraph.qNode.oNode.SetRectangle(|
                    self.gRec.eX + (self.gRec.eW / 2)*(1 + sin(locAlpha) * 2/3), |
                    self.gRec.eY + self.eDepth + ((self.gRec.eH - self.eDepth) / 2)*(1 + cos(locAlpha) * 2/3))
  ...
  if locA and locB
    ...
    if (parX^2/locA^2 + parY^2/locB^2) <= 1         ! If inside an ellipse then
      ...
      loop until self.iDiagram.Next(self.qGraph.qNode) ! Cycle through the nodes
        ...
        locAlphaE = locAlphaB + locAngle * abs(self.iDiagram.AToLY(self.qGraph.qNode.gXY.eY))
        ...
        locSum += abs(self.iDiagram.AToLY(self.qGraph.qNode.gXY.eY))
      end
...
locX        real, auto
 code
  if ~self.iDiagram.ClusterSearch(self.qGraph.qNode.eClusterID)
    locX = self.gRec.eX + self.iDiagram.AToLX(-self.iDiagram.AxisListMinY())
    if self.qGraph.qNode.gXY.eY < 0
      locX += self.iDiagram.ClusterSumNh()
    else
      locX += self.iDiagram.ClusterSumPh()
    end
    self.qGraph.qNode.oNode.SetRectangle(locX,self.iDiagram.ClusterPos(),,self.iDiagram.AToLX(self.qGraph.qNode.gXY.eY))
    case self.eSubType
    of GraphSubType:Normalized
      self.qGraph.qNode.oNode.gRec.eH *= (self.iDiagram.ClusterSumYmax() / self.iDiagram.ClusterSumY())
    end
    self.qGraph.qNode.oNode.gRec.eH = self.iDiagram.ToLW(self.iDiagram.ToW(self.qGraph.qNode.oNode.gRec.eH))
    if self.qGraph.qNode.gXY.eY < 0
      self.iDiagram.ClusterSumNh(self.iDiagram.ClusterSumNh() + self.qGraph.qNode.oNode.gRec.eH)
    else
      self.iDiagram.ClusterSumPh(self.iDiagram.ClusterSumPh() + self.qGraph.qNode.oNode.gRec.eH)
    end
  end
!
!
 ...
 code
  if pointer(self.qGraph) % 2
    if ~self.iDiagram.ClusterSearch(self.qGraph.qNode.eClusterID)
      ...
      locPos = self.iDiagram.AToLX(self.qGraph.qNode.gXY.eY-self.iDiagram.AxisListMinY())
      ...
      if ~self.iDiagram.Next(self.qGraph)
        if ~self.iDiagram.Set(self.qGraph.qNode, savNodePointer)
          ...
          if locPos > self.iDiagram.AToLX(self.qGraph.qNode.gXY.eY-self.iDiagram.AxisListMinY())
            locPos = self.iDiagram.AToLX(self.qGraph.qNode.gXY.eY-self.iDiagram.AxisListMinY())
          end
        end
...
GraphBarClass.CalcNode              procedure
 code
  if ~self.iDiagram.ClusterSearch(self.qGraph.qNode.eClusterID)
    self.qGraph.qNode.oNode.SetRectangle(self.gRec.eX + self.iDiagram.AToLX(-self.iDiagram.AxisListMinY()), |
                                         self.iDiagram.ClusterPos(),, |
                                         self.iDiagram.AToLX(self.qGraph.qNode.gXY.eY) )
    self.iDiagram.ClusterPos(self.iDiagram.ClusterPos() + self.eBarRadius*2*(1 - self.iDiagram.BarOverlap()))
  end
!
...
savNodePointer    long, auto
 code
  if self.iDiagram.IsNullPar(self.qGraph.qNode) then return 0 end
  savNodePointer = pointer(self.qGraph.qNode)
  self.iDiagram.Set(self.qGraph.qNode)
  loop until self.iDiagram.Next(self.qGraph.qNode)  ! Cycle through the nodes
    if self.qGraph.qNode.oNode &= null then cycle end
...
GraphColumnWithAccumulationClass.CalcNode procedure
 code
  if ~self.iDiagram.ClusterSearch(self.qGraph.qNode.eClusterID)
    if self.qGraph.qNode.gXY.eY < 0
      self.qGraph.qNode.oNode.SetRectangle(self.iDiagram.ClusterPos(), |
                                           self.AtoLY(0) + self.iDiagram.ClusterSumNh(),,|
                                           self.iDiagram.AToLY(self.qGraph.qNode.gXY.eY) )
    else
      self.qGraph.qNode.oNode.SetRectangle(self.iDiagram.ClusterPos(), |
                                           self.AtoLY(0) + self.iDiagram.ClusterSumPh(),,|
                                           self.iDiagram.AToLY(self.qGraph.qNode.gXY.eY) )
    end
    case self.eSubType
    of GraphSubType:Normalized
    ...
    if ~self.iDiagram.ClusterSearch(self.qGraph.qNode.eClusterID)
      ...
      if ~self.iDiagram.Next(self.qGraph)
        if ~self.iDiagram.Set(self.qGraph.qNode, savNodePointer)
          ...
          if locYpos > self.iDiagram.AToLY(self.qGraph.qNode.gXY.eY-self.iDiagram.AxisListMinY()) ! Minimum
            locYpos = self.iDiagram.AToLY(self.qGraph.qNode.gXY.eY-self.iDiagram.AxisListMinY())
          end
        end
        self.iDiagram.Previous(self.qGraph)         ! Restoration of the pointer
        self.iDiagram.Set(self.qGraph.qNode, savNodePointer)
...
GraphColumnClass.CalcNode           procedure
 code
  if ~self.iDiagram.ClusterSearch(self.qGraph.qNode.eClusterID)
    self.qGraph.qNode.oNode.SetRectangle(self.iDiagram.ClusterPos(), self.AtoLY(0),, |
                                         self.iDiagram.AToLY(self.qGraph.qNode.gXY.eY) )
    self.iDiagram.ClusterPos(self.iDiagram.ClusterPos() + self.eBarRadius*2*(1 - self.iDiagram.BarOverlap()))
  end
!
...
!
r:AddItem         routine
  lq.eX = self.AtoLX(self.qGraph.qNode.gXY.eX)
  lq.eY = self.AtoLY(self.qGraph.qNode.gXY.eY)
  add(lq)
  if self.iDiagram.ErrCode(errorcode()) then return end
!
 ...
 code
  if ~self.iDiagram.Set(self.qGraph.qNode, 1)
    ...
    loop until self.iDiagram.Next(self.qGraph.qNode) ! Cycle through the nodes
      ...
      self.iDiagram.XYline( self.AtoLX(savXY.eX), self.AtoLY(savXY.eY), |
                            self.AtoLX(self.qGraph.qNode.gXY.eX), self.AtoLY(self.qGraph.qNode.gXY.eY))
      savXY = self.qGraph.qNode.gXY
    end
    if self.eDrawNode                               ! Draw the node
      self.DrawNode
...
GraphDiagramClass.CalcNode          procedure
 code
!
GraphDiagramClass.CalcSliceSum      procedure
 code
!
...
!
GraphDiagramClass.AToLX             procedure(real parValue)
 code
  return self.gRec.eX + self.iDiagram.AToLX(parValue-self.iDiagram.AxisListMinX())
!
GraphDiagramClass.AToLY             procedure(real parValue)
 code
  return self.gRec.eY + self.iDiagram.AToLY(parValue-self.iDiagram.AxisListMinY())
!
...
locI                  signed, auto
 code
  if ~(self.qLegend &=null)
    loop locI = 1 to records(self.qLegend)
      get(self.qLegend, locI) ; if errorcode() then break end
      self.qLegend.eText &= null
    end
    free(self.qLegend)
  end
!
GraphLegendClass.Clear:qLegend      procedure
 code
  if ~(self.qLegend &=null)
    clear(self.qLegend)
  end
...
locI      long
 code
  if self.iLegend.IsNullPar(self.qGraph) then return end
...
savP          long
savRow        long
locRW         real, dim(abs(self.eRows)+10)
savW          real
locX          real
locY          real
locMaxW       real
...
?   assert(maximum(locRw,1) => self.eRows, maximum(locRw,1) &':'& self.eRows)
...
GraphPrimitiveClass.Destruct        procedure
 code
  dispose(self.qTStyle)
  dispose(self.qGrMeasure)
  dispose(self.qGrStyle)
  dispose(self.qGrFont)
!
GraphPrimitiveClass.FParent    procedure(<long parField>)
 code
  if ~omitted(parField) then self.eFParent = parField end
  return self.eFParent
!
GraphPrimitiveClass.ErrCode         procedure(<signed parErrorcode>)
  code
  if ~omitted(parErrorcode) then self.eErrorcode = parErrorCode end
...
locArguments    &cstring
 code
  ...
  if ~FormatMessageA(locFlags, 0, parErrorCode, 0, locMsg, size(locMsg), locArguments)
    clear(locMsg)
  END
? assert(locArguments &= null, 'locArguments')
  dispose(locArguments)
  return clip(locMsg)
!
...
locRGB      long, auto
 code
  ...
  return locRGB
!
GraphPrimitiveClass.IsNullPar            procedure(*queue parQ)
 code
  self.ErrCode(0)
  if parQ &= null
...
GraphPrimitiveClass.Set             procedure(*queue parQ, long parPointer=0)
 code
  if self.IsNullPar(parQ) then return self.ErrCode() end
  if parPointer < 0
...
GraphPrimitiveClass.Previous        procedure(*queue parQ)
 code
  ...
  return errorcode()
!
GraphPrimitiveClass.NextID          procedure(queue parQ, *signed parID)
locID               unsigned
savPointer          unsigned, auto
locPointer          unsigned, auto
 code
  if ~self.IsNullPar(parQ)
    if records(parQ)
      savPointer = pointer(parQ)
      get(parQ, records(parQ))
      if ~errorcode()
        locID = parID
      end
      locID += 1
      ...
      loop
        ...
        if locID = parID then locID += 1 ; locPointer = 0 end
      end
      if errorcode() = NoEntryErr
        get(parQ, savPointer)
?       assert(~(errorcode()=NoEntryErr))
        parID = locID
      else
...
! Checks a box
 code
  return choose( choose(parBoxX > parBoxX + parBoxW, inrange(parX, parBoxX + parBoxW, parBoxX), |
                                                     inrange(parX, parBoxX, parBoxX + parBoxW)) and |
                 choose(parBoxY > parBoxY + parBoxH, inrange(parY, parBoxY + parBoxH, parBoxY), |
                                                     inrange(parY, parBoxY, parBoxY + parBoxH)) )
!
GraphPrimitiveClass.Inbox           procedure(real parX, real parY, gXYType parXY, gWHDType parWHD)
! Checks a box
 code
  return choose( choose(parXY.eX > parXY.eX + parWHD.eW, inrange(parX, parXY.eX + parWHD.eW, parXY.eX), |
                                                         inrange(parX, parXY.eX, parXY.eX + parWHD.eW)) and |
                 choose(parXY.eY > parXY.eY + parWHD.eH, inrange(parY, parXY.eY + parWHD.eH, parXY.eY), |
...
locAngle        real, auto
 code
  ...
  if omitted(parX4) or omitted(parY4)
...
! factors of recalculation from the logic coordinates in the coordinates of the device
 code
  ...
  if ~omitted(parXb) then self.gFactorXY.eXb = round(parXb,1) end
  if ~omitted(parYb) then self.gFactorXY.eYb = round(parYb,1) end
  ! Factors of recalculation from logic units in units Devices
  ! usually, Õ-factor (coeff.) is equal to Y-factor
  if ~omitted(parFx) then self.gFactorXY.eFx = parFx end
  if ~omitted(parFy) then self.gFactorXY.eFy = parFy end
...
locP      like(gPositionType)
 code
  if ~omitted(parW) or ~omitted(parH)
    if self.eGrField
    ...
    if ~omitted(parW) then parW = locP.eW end
    if ~omitted(parH) then parH = locP.eH end
  else
...
! Read font parameters
 code
  if omitted(parField) then parField = 0 end
...
savPointer      long, auto
 code
  if self.IsNullPar(parQ) then return end
...
GraphPrimitiveClass.Box             procedure(real parX, real parY, real parW, real parH, <*gFillType parFill>)
 code
  box(self.ToX(parX), self.ToY(parY), self.ToW(parW), self.ToH(parH), |
      choose(~omitted(parFill),parFill.eColor,color:none))
!
 ...
 code
  if ~self.IsNullPar(parQ)
    if records(parQ)
      ...
      polygon(locM, choose(~omitted(parFill),parFill.eColor,color:none))
    end
  end
!
...
locCos    signed, auto
 code
  ...
  self.PopStyle
!
GraphPrimitiveClass.VBar            procedure(*qBarPartstype parBar)
! Vertical rectangle, width = 2R
locM      signed, dim(8), auto
locX      signed, auto
locY      signed, auto
...
locCos    signed, auto
 code
  ...
  loop until self.Next(parBar)
    ...
    if locH > 0
      locY = self.ToY(parBar.gRec.eY) + locH
      locH = -locH
    end
    locR2 = self.ToW(parBar.eRadius*2)              ! Width of a figure
    ! Front facet
    locM[1] = locX                ; locM[2] = locY
    locM[3] = locM[1]             ; locM[4] = locM[2] + locH
    locM[5] = locM[3] + locR2     ; locM[6] = locM[4]
    ...
    if parBar.eDepth <> 0
      locCos = self.ToW(parBar.eDepth*cos(equ:DegToRad*45))
      locSin = self.ToH(parBar.eDepth*sin(equ:DegToRad*45))
      ! Upper facet
      locM[1] = locX              ; locM[2] = locY + locH
      locM[3] = locM[1] + locCos  ; locM[4] = locM[2] + locSin
      locM[5] = locM[3] + locR2   ; locM[6] = locM[4]
  ...
  self.PopStyle
!
GraphPrimitiveClass.VCylinder       procedure(*qBarPartstype parBar)
! Vertical cylinder with width(height) 2*R
locM        signed, dim(8), auto
locX        long, auto
locY        long, auto
...
locSign     long, auto
 code
  ...
  loop until self.Next(parBar)
    ...
    locR2 = self.ToW(parBar.eRadius*2)              ! Width of a figure
    locHalfH2 = self.ToH(parBar.eDepth)/2
...
r:DrawFrontFacet     routine                        ! Front facet
  ...
  polygon(locM, parBar.gFill.eColor)
!
GraphPrimitiveClass.HBar            procedure(*qBarPartstype parBar)
! Vertical rectangle, width = 2R
locM      signed, dim(8), auto
locX      signed, auto
locY      signed, auto
...
locCos    signed, auto
 code
  ...
  self.Set(parBar)
  loop until self.Next(parBar)
    locR2 = self.ToH(parBar.eRadius*2)              ! Height of a figure
    locW = self.ToW(parBar.gRec.eH)
    if locW < 0
      locX = self.ToX(parBar.gRec.eX) + locW
      locW = -locW
    end
    ! Front facet
    locM[1] = locX                ; locM[2] = locY
    locM[3] = locM[1]             ; locM[4] = locM[2] + locR2
    locM[5] = locM[3] + locW      ; locM[6] = locM[4]
    locM[7] = locM[5]             ; locM[8] = locM[2]
    polygon(locM, parBar.gFill.eColor)
    if parBar.eDepth <> 0
      locCos = self.ToW(parBar.eDepth*cos(equ:DegToRad*45))
      locSin = self.ToH(parBar.eDepth*cos(equ:DegToRad*45))
      ! Upper facet
      locM[1] = locX              ; locM[2] = locY + locR2
      locM[3] = locM[1] + locCos  ; locM[4] = locM[2] + locSin
      locM[5] = locM[3] + locW    ; locM[6] = locM[4]
      locM[7] = locM[1] + locW    ; locM[8] = locM[2]
      polygon(locM, parBar.gFill.eColor)
      ! Right facet
      locM[1] = locX + locW       ; locM[2] = locY + locR2
      locM[3] = locM[1] + locCos  ; locM[4] = locM[2] + locSin
      locM[5] = locM[3]           ; locM[6] = locM[4] - locR2
      locM[7] = locM[1]           ; locM[8] = locY
      polygon(locM, parBar.gFill.eColor)
    end
    locX += locW                                    ! New coordinate X
  end
  self.PopStyle
!
GraphPrimitiveClass.HCylinder       procedure(*qBarPartstype parBar)
! Vertical cylinder with width(height) 2*R
locM        signed, dim(8), auto
locX        signed, auto
locY        signed, auto
...
locSign     signed, auto
 code
  ...
  loop until self.Next(parBar)
    ...
    locHalfH2 = self.ToW(parBar.eDepth)/2
    if locHalfH2 = 0
      do r:DrawFrontFacet
    else
      self.SetStyle(parBar.gFill.eColor)
      ...
      line(locX+locHalfH2, locY, locW, 0)
      line(locX+locHalfH2, locY+locR2, locW, 0)
      ellipse(locX+locW, locY, locHalfH2*2, locR2, parBar.gFill.eColor)
    end
    locX += locW                                    ! New coordinate X
  end
  self.PopStyle
...
locH      long
 code
  self.PushStyle
  self.PushFont
  if ~omitted(parFont) then self.SetFont(parFont) end
...
locRet        any
 code
  locRet = ''
  if parFileName
    if ~omitted(parFileName)
      locFileName = clip(parFileName)
      FnSplit(locFileName, locDrv, locDir, LocName, locExt)
    end
    if ~omitted(parDrv)  then locDrv = clip(parDrv) end
    if ~omitted(parDir)  then locDir = clip(parDir) end
    if ~omitted(parName) then locName = clip(parName) end
    if ~omitted(parExt)  then locExt = clip(parExt) end
...
locNewFilename    any
 code
  self.ErrCode(0)
  loop 100 times
    locFileName = GetTempFileName(choose(~omitted(parPrefix), parPrefix, ''))
    if omitted(parExt) then break end
...
GraphBasicClass.Destruct            procedure
 code
  ...
  self.Free:qCluster
  dispose(self.qCluster)
  self.Free:qGraph
  dispose(self.qGraph)
  dispose(self.oLegend)
  dispose(self.oTitle)
!
...
! Find diagram in list
 code
  if self.IsNullPar(self.qGraph) then return self.ErrCode() end
...
GraphBasicClass.GraphFill           procedure(<long parColor>, <long parColor2>, <long parStyle>)
 code
  if self.IsNullPar(self.qGraph) then return end
  if ~omitted(parColor)  then self.qGraph.gFill.eColor = parColor end
  if ~omitted(parColor2) then self.qGraph.gFill.eColor2 = parColor2 end
  if ~omitted(parStyle)  then self.qGraph.gFill.eStyle = parStyle end
  put(self.qGraph)
  self.ErrCode(errorcode())
!
...
locI            long
 code
  if self.IsNullPar(self.qGraph) then return locColor end
...
GraphBasicClass.Free:qCluster       procedure
 code
  if ~self.IsNullPar(self.qCluster)
...
locID      long
 code
  if self.IsNullPar(self.qCluster) then return self.ErrCode() end
  if self.ClusterSearch(parName, false)
    if ~self.NextID(self.qCluster, self.qCluster.eID)
    ...
    do r:SetText
    if ~omitted(parCalcType) then self.qCluster.eCalcType = parCalcType end
...
GraphBasicClass.Clear:qNode          procedure
 code
  if ~self.IsNullPar(self.qGraph.qNode)
...
GraphBasicClass.Free:qSelectedGraph  procedure
 code
  if ~self.IsNullPar(self.qSelectedGraph)
...
! Node search in list of current diagram
 code
  if self.IsNullPar(self.qGraph.qNode) then return self.ErrCode() end
...
locID      long
 code
  ...
  if ~omitted(parType) then self.qGraph.qNode.eType = parType end
  self.qGraph.qNode.gFill.eColor = color:auto
  self.qGraph.qNode.gFill.eColor2 = color:none
  if ~omitted(parName) then self.qGraph.qNode.eName = clip(parName) end
  ...
  if self.qGraph.qNode.eClusterID
    if ~self.ClusterSearch(self.qGraph.qNode.eClusterID)
      if self.qGraph.qNode.gXY.eX < 0
        self.qCluster.gSumN.eX += self.qGraph.qNode.gXY.eX
      else
        self.qCluster.gSumP.eX += self.qGraph.qNode.gXY.eX
      end
      if self.qGraph.qNode.gXY.eY < 0
        self.qCluster.gSumN.eY += self.qGraph.qNode.gXY.eY
      else
        self.qCluster.gSumP.eY += self.qGraph.qNode.gXY.eY
      end
...
GraphBasicClass.NodeFill            procedure(<long parColor>, <long parColor2>, <long parStyle>)
 code
  if self.IsNullPar(self.qGraph.qNode) then return end
  if ~omitted(parColor)  then self.qGraph.qNode.gFill.eColor = parColor end
  if ~omitted(parColor2) then self.qGraph.qNode.gFill.eColor2 = parColor2 end
  if ~omitted(parStyle)  then self.qGraph.qNode.gFill.eStyle = parStyle end
...
! Renew node in the list
 code
  if ~self.NodeSearch(parNode)                      ! Searching by number (number is node's ID)
    if ~omitted(parX) then self.qGraph.qNode.gXY.eX = parX end
    if ~omitted(parY) then self.qGraph.qNode.gXY.eY = parY end
    if ~omitted(parType) then self.qGraph.qNode.eType = parType end
    if ~omitted(parFill) then self.qGraph.qNode.gFill = parFill end
    if ~omitted(parName) then self.qGraph.qNode.eName = clip(parName) end
    put(self.qGraph.qNode)
    if ~self.ErrCode(errorcode())
      self.UpdatingMinMax
...
GraphBasicClass.SynchronizeWithSelectedNode procedure
 code
  self.Clear:qGraph
  if self.IsNullPar(self.qSelectedGraph) or self.IsNullPar(self.qGraph) then return end
  if ~self.IsNullPar(self.qSelectedGraph.qSelectedNode)
...
!
GraphBasicClass.GraphType           procedure(<signed parGraphType>, <bool parAxisListSwap>)
 code
  if ~omitted(parGraphType)
    ! swap of axes ???
    if choose(~omitted(parAxisListSwap), parAxisListSwap, self.eAxisListAutoSwap)
      case parGraphType
    ...
    elsif ~omitted(parAxisListSwap) and ~parAxisListSwap
      self.eAxisListSwap = false
    end
    self.eGraphType = parGraphType
  end
...
GraphBasicClass.iText.SetStyle      procedure(<long parColor>, <long parPenWidth>, <long parPenStyle>)
 code
  if omitted(parColor) and omitted(parPenWidth) and omitted(parPenStyle)
    self.SetStyle
  elsif ~omitted(parColor) and omitted(parPenWidth) and omitted(parPenStyle)
...
GraphBasicClass.iText.GetTextPoint  procedure(long parField=0, string parText, <*? parW>, <*? parH>)
 code
  if omitted(parW) and ~omitted(parH)
    self.GetTextPoint(parField, parText,, parH)
  elsif ~omitted(parW) and omitted(parH)
...
GraphBasicClass.iText.FactorYb      procedure(<real parValue>)
 code
  return choose(~omitted(parValue), self.FactorYb(parValue), self.FactorYb())
!
...
!
! iLegend interface
GraphBasicClass.iLegend.IsNullPar        procedure(*queue parQ)
 code
  return self.IsNullPar(parQ)
!
...
GraphAxisClass.Destruct             procedure
 code
  dispose(self.qStrokeY)
  dispose(self.qStrokeX)
  dispose(self.oAxisYname)
  dispose(self.oAxisXname)
!
...
! Sets factors for transformation of absolute coordinates to logic coordinates
 code
  if ~omitted(parFx) then self.gAxisFactor.eX = parFx end
  if ~omitted(parFy) then self.gAxisFactor.eY = parFy end
...
! Sets min./max. values for the axes
 code
  if ~omitted(parXmin) then self.gAxisMin.eX = parXmin end
  if ~omitted(parXmax) then self.gAxisMax.eX = parXmax end
  if ~omitted(parYmin) then self.gAxisMin.eY = parYmin end
  if ~omitted(parYmax) then self.gAxisMax.eY = parYmax end
!
...
locCount              signed
 code
  ...
  orof GraphType:BarWithAccumulation
    if records(self.qCluster)
      self.Set(self.qCluster)                       ! Cycle through the cluster
      loop until self.Next(self.qCluster)
        locCount += 1
        if self.gAxisMin.eX > self.qCluster.gSumN.eX
          self.gAxisMin.eX = self.qCluster.gSumN.eX
        end
        if self.gAxisMin.eY > self.qCluster.gSumN.eY
          self.gAxisMin.eY = self.qCluster.gSumN.eY
        end
        if self.gAxisMax.eX < self.qCluster.gSumP.eX
          self.gAxisMax.eX = self.qCluster.gSumP.eX
        end
        if self.gAxisMax.eY < self.qCluster.gSumP.eY
          self.gAxisMax.eY = self.qCluster.gSumP.eY
        end
      end
    end
  else
    ...
    if ~self.AxisListScaleMinMax()
      if self.gAxisMin.eX > 0 and self.gAxisMax.eX > 0
        self.gAxisMin.eX = 0
      elsif self.gAxisMin.eX < 0 and self.gAxisMax.eX < 0
        self.gAxisMax.eX = 0
      end
      if self.gAxisMin.eY > 0 and self.gAxisMax.eY > 0
        self.gAxisMin.eY = 0
      elsif self.gAxisMin.eY < 0 and self.gAxisMax.eY < 0
        self.gAxisMax.eY = 0
      end
    end
  end
!
GraphAxisClass.CalcAxisList         procedure  ! Calculation of axes
locW            real, auto
swapName        &GraphTextClass,AUTO
swapFormat      LIKE(SELF.eAxisXFormat),AUTO
 code
  free(self.qStrokeX)
  free(self.qStrokeY)
  if self.eAxisListSwap                             ! swap of names ???
    swapName &= SELF.oAxisXName
    SELF.oAxisXName &= SELF.oAxisYName
    SELF.oAxisYName &= swapName
    swapFormat = SELF.eAxisXFormat
    SELF.eAxisXFormat = SELF.eAxisYFormat
    SELF.eAxisYFormat = swapFormat
    self.eAxisListSwap = false
  end
  !
  if ~band(self.eAxisListStyle,AxisListStyle:NoneX) and self.eAxisXname
  ...
  if ~band(self.eAxisListStyle,AxisListStyle:NoneY) and self.eAxisYname
  ...
  !
  if ~band(self.eAxisListStyle,AxisListStyle:NoneX) ! If have to draw the axis
    self.gGraphDist.eB += self.eAxisYThickness
    self.gGraphDist.eR += 5 + self.eAxisXThickness  ! X-axis arrow length
  end
  if ~band(self.eAxisListStyle,AxisListStyle:NoneY) ! If have to draw the axis
...
locIter         SHORT,AUTO
 code
  ...
  of 1                                              ! Axis X
    ...
    locGrid = choose(self.eAxisListGrid and self.eAxisXGrid)
    ! (IMAGE width - left indent - arrow length)
    locLength = self.gGraphRect.eW - self.gGraphDist.eL - self.gGraphDist.eR - locBy
    case self.GraphType()                           ! Define minimal scale step in absolute units
    of GraphType:BarChart
    orof GraphType:FloatingBar
    orof GraphType:BarWithAccumulation
      locLenA = self.gAxisMax.eY-self.gAxisMin.eY
      if self.gAxisMax.eY > 0 and self.gAxisMin.eY < 0 then locMin &= self.gAxisMin.eY end
    else
      locLenA = self.gAxisMax.eX-self.gAxisMin.eX
      if self.gAxisMax.eX > 0 and self.gAxisMin.eX < 0 then locMin &= self.gAxisMin.eX end
    end
    locNone = AxisListStyle:NoText + AxisListStyle:NoneX
    case choose(self.eAxisListScale = Scale:Default, self.eAxisListXScale, self.eAxisListScale) !!!
    of Scale:AsMSWord                               ! As Word
      do r:CalcAsWord
    else
      locMaximumScale = locLenA
    end
  ...
  of 2                                              ! Axis Y
    ...
    locGrid = choose(self.eAxisListGrid and self.eAxisYGrid)
    ...
    locLenA = self.gAxisMax.eY-self.gAxisMin.eY
    locNone = AxisListStyle:NoText + AxisListStyle:NoneY
    case choose(self.eAxisListScale = Scale:Default, self.eAxisListXScale, self.eAxisListScale)
    of Scale:AsMSWord                               ! As Word
      do r:CalcAsWord
    else
  ...
  if locLength < 0 then locSign = -1 else locSign = 1 end
  locLength = abs(locLength)
  if ~(locMin &= null)
    locNull = locLength * abs(locMin)/locMaximumScale
  end
  ! Calculation of a scale --------------------------------------------------------------
  locD = locNull
  if locNull <> 0 then locStep = 0 else locStep = 1 end
? locIter=0
  loop
    if locStep > 0 then locD += locBy
    elsif locStep < 0 then locD -= locBy
    end
? locIter += 1
?   assert(~choose(locIter  > 10000),'<13,10>too much iterations!!! on CalcAxis')
    if locD > locLength
      locD = locNull
      locI = 0
      locStep = -1
    ...
    if locD < 0 or locD > locLength then break end
    locI += locStep
    if locStep = 0 then locStep = 1 end
    self.StrokeAdd(parQ, locI,, locD * locSign)
    if ~(locI % 10)
      if band(self.eAxisListStyle,AxisListStyle:NoStroke3) then cycle end ! DON'T display
      if ~band(self.eAxisListStyle,locNone)         ! If we have to display text then
        if locI = 0
          case parAxis
          of 1                                        ! Axis X
            parQ.eText = self.GetXTextPoint(0, parQ.eTextW, parQ.eTextH)
          of 2                                        ! Axis Y
            parQ.eText = self.GetYTextPoint(0, parQ.eTextW, parQ.eTextH)
          end
        else
          case parAxis
          of 1                                        ! Axis X
            ...
            orof GraphType:FloatingBar
            orof GraphType:BarWithAccumulation !???
              parQ.eText = self.GetXTextPoint(self.gAxisMin.eY+locD*self.gAxisFactor.eX, parQ.eTextW, parQ.eTextH)
            else
              parQ.eText = self.GetXTextPoint(self.gAxisMin.eX+locD*self.gAxisFactor.eX, parQ.eTextW, parQ.eTextH)
            end
          of 2                                        ! Axis Y
            parQ.eText = self.GetYTextPoint(self.gAxisMin.eY+locD*self.gAxisFactor.eY, parQ.eTextW, parQ.eTextH)
          end
        end
      ...
      if band(self.eAxisListStyle,AxisListStyle:NoStroke2) then cycle end ! DON'T display
      parQ.eLen  = 6                                ! Normal stroke
      parQ.eThickness = 1 !locThickness/2
    else
      if band(self.eAxisListStyle,AxisListStyle:NoStroke1) then cycle end ! DON'T display
...
r:CalcAsWord          routine
  locLenA = abs(locLenA)
  if locLenA < 1
    locExponent = int(log10(locLenA))-2
  else
    locExponent = int(log10(locLenA))-1
  end
  locCoefficient = locLenA/10^locExponent
  ...
  if locLenA % (locCoefficient*10^locExponent) <> 0
    locMaximumScale = (int(locLenA/(locCoefficient*10^locExponent))+1)*locCoefficient*10^locExponent
  else
    locMaximumScale = locLenA
  end
  locBy = locLength / (locMaximumScale/(locCoefficient*10^locExponent)) / 10
? assert(~choose(round(locBy,1.0e-10) = 0),'Error: locBy=0 (Precisely =' & locBy &')')
!
...
locGrid         bool
 code
  ...
  if locBarGroups=0 then locBarGroups = 1 end
  ! Scale interval
  case parAxis
  of 1                                              ! Axis X
  ...
  loop locI = 1 to locBarGroups
    ...
    put(self.qCluster)
    if band(self.eAxisListStyle,locNone) then cycle end ! If not to display the text then cycle
    if ~(self.qCluster.oText &= null)
...
!
GraphAxisClass.DrawAxisList         procedure       ! Draw axes
 code
  !
  if ~band(self.eAxisListStyle,AxisListStyle:NoneX) and self.eAxisXname
...
!
GraphAxisClass.GetXTextPoint        procedure(? parValue, <*? parW>, <*? parH>, <*? parMaxLen>)
locText       any
locTextW      real, auto
locTextH      real, auto
 code
  if self.eAxisXFormat                              ! Horizontal axis' number format
    locText = clip(format(parValue,self.eAxisXFormat))
  else                                              ! Automatic numbers formatting
    locText = clip(round(parValue,self.gAxisFactor.eX))
  end
  self.GetTextPoint(self.FParent(),locText,locTextW,locTextH)
  if ~omitted(parW) then parW = locTextW end
  if ~omitted(parH) then parH = locTextH end
  if ~omitted(parMaxLen)
...
locTextW      real
 code
  if band(self.eAxisListStyle,AxisListStyle:NoStroke3) or | ! If do NOT show or
     band(self.eAxisListStyle,AxisListStyle:NoText+AxisListStyle:NoneY) ! do NOT draw the text, then
    return 0
  end
  case self.GraphType()
...
locDistB        real
 code
  if band(self.eAxisListStyle,AxisListStyle:NoText+AxisListStyle:NoneX) then return 0 end
  case self.GraphType()
  of GraphType:ColumnChart                          ! Histogram (vertical columns)
  orof GraphType:ColumnWithAccumulation
  orof GraphType:FloatingColumn
...
savTextY        real
 code
  if band(self.eAxisListStyle,AxisListStyle:NoneY) then return end ! DON'T display axis
  self.PushStyle
  self.SetStyle
  ...
  loop until self.Next(self.qStrokeY)
    ...
    if self.qStrokeY.eLen                           ! If there is a strike, then draw
      self.HLine(locP.eX-self.qStrokeY.eLen/2, locP.eY+self.qStrokeY.ePos,|
                      self.qStrokeY.eLen+self.eAxisYThickness, 0)!self.qStrokeY.eThickness)
    end
...
locLen          long
 code
  if band(self.eAxisListStyle,AxisListStyle:NoneX) then return end ! DON'T display axis
  self.PushStyle
  self.SetStyle
  locP = self.gGraphRect
  locP.eX += self.gGraphDist.eL - self.eAxisXThickness
  ...
  loop until self.Next(self.qStrokeX)
    if self.qStrokeX.eText and (locLen <= locP.eX+self.qStrokeX.ePos-self.qStrokeX.eTextW/2) and |
      ...
      locLen = locP.eX+self.qStrokeX.ePos+self.qStrokeX.eTextW/2 !+ 5 + self.eAxisXThickness
      ! Scale text
  ...
  self.PopStyle
!
GraphAxisClass.StrokeAdd            procedure(qStrokeType parQ, <long parID>, <string parText>, <real parPos>, |
                                              <real parLen>, <byte parGrid>)
! Add stroke description
 code
  clear(parQ)
  if omitted(parID)
    if ~self.NextID(parQ, parQ.eID)
      do r:Set
      add(parQ, +parQ.eID)
    end
  else
...
r:Set   routine
  if ~omitted(parText) then parQ.eText = parText end
  if ~omitted(parPos)  then parQ.ePos  = parPos end
  if ~omitted(parLen)  then parQ.eLen  = parLen end
  if ~omitted(parGrid) then parQ.eGrid = parGrid end
!
GraphAxisClass.AxisListScaleMinMax  procedure(<bool parValue>)
 code
  if ~omitted(parValue)
    self.eAxisListScaleMinMax = choose(parValue)
  end
  return self.eAxisListScaleMinMax
!
...
GraphClass.SetDefault               procedure       ! Set initial values
 code
  ...
  clear(self.ePopUpSubAxisList,1)
  clear(self.ePopUpSubNode,1)
  clear(self.ePopUpSubWallpaper,1)
...
GraphClass.NodeXText                procedure(bool parShow=true)
 code
  ...
  if self.eAxisXFormat
     return format(self.qGraph.qNode.gXY.eX,self.eAxisXFormat)
  else
...
GraphClass.NodeYText                procedure(bool parShow=true)
 code
  if ~parShow or self.qGraph.qNode &= null then return '' end
  if self.eAxisYFormat
     return format(self.qGraph.qNode.gXY.eY,self.eAxisYFormat)
  else
...
GraphClass.DrawGraph                procedure       ! Draw diagrams
 code
  ...
  self.DrawAxisList                                 ! To draw axes
  !
  if self.DrawBarWithAccumulation()
    self.Set(self.qGraph)
    loop until self.Next(self.qGraph)
      if ~(self.qGraph.oDiagram &= null)
        case self.GraphType()
...
GraphClass.DrawBarWithAccumulation  procedure
locQ    qBarPartstype
 code
  case self.GraphType()
  of GraphType:ColumnWithAccumulation
  orof GraphType:BarWithAccumulation
    ...
    loop until self.Next(self.qCluster)
      ...
      loop until self.Next(self.qGraph)
        ...
        loop until self.Next(self.qGraph.qNode)
          if self.qGraph.qNode.oNode &= null then cycle end
          if self.qGraph.qNode.eClusterID <> self.qCluster.eID then cycle end
          locQ.gRec    = self.qGraph.qNode.oNode.gRec
          locQ.gFill   = self.qGraph.qNode.oNode.gFill
          locQ.eRadius = self.qGraph.oDiagram.eBarRadius
          locQ.eDepth  = self.qGraph.oDiagram.eDepth
          if locQ.gRec.eH < 0
            add(locQ, 1)
          else
            add(locQ)
      ...
      if ~records(locQ) then cycle end
      case self.GraphType()
      of GraphType:ColumnWithAccumulation
    ...
    return err:InCorrectType
  end
  return NoError

!
GraphClass.DrawWallPaper            procedure(<unsigned parStyle>)
 code
  if ~self.eWallpaperFile or self.eWallpaper = Wallpaper:None
    self.eFBand{prop:text} = ''
  else                                              ! If background picture stated then
    self.eFBand{prop:text} = self.eWallpaperFile    ! display it
    case choose(~omitted(parStyle), parStyle, self.eWallpaper) ! Style
    of Wallpaper:Stretched
      self.eFBand{prop:tiled} = false
      self.eFBand{prop:centered} = false
    of Wallpaper:tiled
      self.eFBand{prop:tiled} = true
    of Wallpaper:centered
      self.eFBand{prop:centered} = true
    end
  end
!
...
? assert(choose(~locTmpFileName,false,true),'<13,10>Method GraphClass.DrawReport()')
...
GraphClass.CalcGraph                procedure
 code
  ...
  self.CalcAxisList                                 ! To calculate axes
  !
  case self.GraphType()
  of GraphType:ColumnWithAccumulation
  orof GraphType:BarWithAccumulation
    ...
    self.Set(self.qCluster)
    loop until self.Next(self.qCluster)
      clear(self.qCluster.eSumNh)
      clear(self.qCluster.eSumPh)
      put(self.qCluster)
      case self.eGraphSubType
      of GraphSubType:Normalized
        if self.eSumYmax < (self.qCluster.gSumP.eY + abs(self.qCluster.gSumN.eY))
          self.eSumYmax = (self.qCluster.gSumP.eY + abs(self.qCluster.gSumN.eY))
        end
      end
    end
  end
...
GraphClass.CalcCurrentGraph         procedure
 code
  dispose(self.qGraph.oDiagram)
  case choose(self.GraphType()=0, self.qGraph.eType, self.GraphType())
  of GraphType:PieChart
  ...
  if ~(self.qGraph.oDiagram &= null)
    ...
    self.qGraph.oDiagram.eType = choose(self.GraphType()=0, self.qGraph.eType, self.GraphType())
    ...
    of GraphType:PieChart
      ...
      self.qGraph.oDiagram.CalcSliceSum
    end
  end
!
...
savValue    any
 code
  ...
  orof event:GraphTypeFloatingBar
    savValue = self.GraphType()
    case event()
    of event:GraphTypeLine              ; self.GraphType(GraphType:Line)
    of event:GraphTypeColumnChart       ; self.GraphType(GraphType:ColumnChart)
    of event:GraphTypeColumnWithAccumulation ; self.GraphType(GraphType:ColumnWithAccumulation)
    of event:GraphTypeFloatingColumn    ; self.GraphType(GraphType:FloatingColumn)
    of event:GraphTypeScatterGraph      ; self.GraphType(GraphType:ScatterGraph)
    of event:GraphTypeAreaGraph         ; self.GraphType(GraphType:AreaGraph)
    of event:GraphTypeFloatingArea      ; self.GraphType(GraphType:FloatingArea)
    of event:GraphTypePieChart          ; self.GraphType(GraphType:PieChart)
    of event:GraphTypeBarChart          ; self.GraphType(GraphType:BarChart)
    of event:GraphTypeBarWithAccumulation ; self.GraphType(GraphType:BarWithAccumulation)
    of event:GraphTypeFloatingBar       ; self.GraphType(GraphType:FloatingBar)
    end
    if self.GraphType() <> savValue
  ...
  !
  of event:AxisListStyle:None
  orof event:AxisListStyle:Standard
  orof event:AxisListStyle:Long
    savValue = self.eAxisListStyle
    case event()
    of event:AxisListStyle:None     ; self.eAxisListStyle = AxisListStyle:None
    of event:AxisListStyle:Standard ; self.eAxisListStyle = AxisListStyle:Standard
    of event:AxisListStyle:Long     ; self.eAxisListStyle = AxisListStyle:Long
    end
    if self.eAxisListStyle <> savValue
      self.PostEvent(event:draw)
    end
  !
  of event:AxisListScale:Linear
  orof event:AxisListScale:AsMSWord
    savValue = self.eAxisListScale
    case event()
    of event:AxisListScale:Linear   ; self.eAxisListScale = Scale:Linear
    of event:AxisListScale:AsMSWord ; self.eAxisListScale = Scale:AsMSWord
    end
    if self.eAxisListScale <> savValue
      self.PostEvent(event:draw)
    end
  !
  ...
  of event:Wallpaper:None
  orof event:Wallpaper:Stretched
  orof event:Wallpaper:Tiled
  orof event:Wallpaper:Centered
    savValue = self.eWallpaper
    case event()
    of event:Wallpaper:Stretched    ; self.eWallpaper = Wallpaper:Stretched
    of event:Wallpaper:Tiled        ; self.eWallpaper = Wallpaper:Tiled
    of event:Wallpaper:Centered     ; self.eWallpaper = Wallpaper:Centered
    of event:Wallpaper:None         ; self.eWallpaper = Wallpaper:None
    end
    if self.eWallpaper <> savValue
      self.DrawWallpaper
      hide(self.eFBand) ; unhide(self.eFBand)
    end
  !
  ...
  of event:GridON orof event:GridOFF                ! On/off grid
    savValue = self.eAxisListGrid
    self.eAxisListGrid = choose(event()=event:GridON)
    if savValue <> self.eAxisListGrid
      self.PostEvent(event:draw)
    end
  ...
  of event:AxisListScaleMinMaxON orof event:AxisListScaleMinMaxOFF ! On/off Scale min/max
    savValue = self.eAxisListScaleMinMax
    self.eAxisListScaleMinMax = choose(event()=event:AxisListScaleMinMaxON)
    if self.eAxisListScaleMinMax <> savValue
      self.PostEvent(event:draw)
    end
  of event:AxisListNameON orof event:AxisListNameOFF        ! On/off axes names
    savValue = choose(self.eAxisXname or self.eAxisYname)
    self.eAxisXname = choose(event()=event:AxisListNameON)
    self.eAxisYname = choose(event()=event:AxisListNameON)
 ...
 code
  ...
  if band(self.ePopUpItems,GraphPop:Figure) or ~self.ePopUpHideItems
    ...
    PopupMgr.SetItemEnable('GraphFigure', choose(band(self.ePopUpItems,GraphPop:Figure) and |
                                                 inlist(self.GraphType(),GraphType:ColumnChart,GraphType:FloatingColumn,|
  ...
  if band(self.ePopUpItems,GraphPop:Gradient) or ~self.ePopUpHideItems
    ...
    PopupMgr.SetItemEnable('Gradient', choose(band(self.ePopUpItems,GraphPop:Gradient) and |
                                              ~inlist(self.GraphType(),GraphType:ScatterGraph,GraphType:Line)))
  end
  !*Not_Implemented*
  ...
  if band(self.ePopUpItems,GraphPop:AxisList) or ~self.ePopUpHideItems
    locSep = false
    PopupMgr.AddItem('Axis','Axis','',1)
    PopupMgr.SetItemEnable('Axis', choose(band(self.ePopUpItems,GraphPop:AxisList)))
    locSep = self.CalcPopupAdd2(PopupMgr, 'Standard', 'AxisListStylesStandard', self.ePopUpSubAxisList, |
                                GraphPop:AxisList:Standard, self.eAxisListStyle, AxisListStyle:Standard)
    locSep += self.CalcPopupAdd2(PopupMgr, 'Long', 'AxisListStylesLong', self.ePopUpSubAxisList, |
                                  GraphPop:AxisList:Long, self.eAxisListStyle, AxisListStyle:Long)
    locSep += self.CalcPopupAdd2(PopupMgr, 'None', 'AxisListStylesNone', self.ePopUpSubAxisList, |
                                  GraphPop:AxisList:None, self.eAxisListStyle, AxisListStyle:None)
    if band(self.ePopUpItems,GraphPop:AxisListName)
      if locSep then PopupMgr.AddItem('-','Sep:AxisListName','',-1) end
      PopupMgr.AddItem('Axis name','AxisListName','',-1)
      PopupMgr.SetItemCheck('AxisListName',choose(self.eAxisXname or self.eAxisYname))
      PopupMgr.SetItemEnable('AxisListName', choose(self.eAxisListStyle <> AxisListStyle:None))
    end
    if band(self.ePopUpItems,GraphPop:Grid)
      if locSep or band(self.ePopUpItems,GraphPop:AxisListName)
        PopupMgr.AddItem('-','Sep:Grid','',-1)
      end
      PopupMgr.AddItem('Grid','Grid','',-1)
      PopupMgr.SetItemCheck('Grid', self.eAxisListGrid)
      PopupMgr.SetItemEnable('Grid', choose(self.eAxisListStyle <> AxisListStyle:None))
      if band(self.ePopUpItems,GraphPop:GridX)
        PopupMgr.AddItem('Grid X','GridX','',-1)
        PopupMgr.SetItemCheck('GridX', self.eAxisXGrid)
        PopupMgr.SetItemEnable('GridX', choose(self.eAxisListGrid and self.eAxisListStyle <> AxisListStyle:None))
      end
      if band(self.ePopUpItems,GraphPop:GridY)
        PopupMgr.AddItem('Grid Y','GridY','',-1)
        PopupMgr.SetItemCheck('GridY', self.eAxisYGrid)
        PopupMgr.SetItemEnable('GridY', choose(self.eAxisListGrid and self.eAxisListStyle <> AxisListStyle:None))
      end
    end
    if band(self.ePopUpItems,GraphPop:AxisListScale)
      if locSep or band(self.ePopUpItems,GraphPop:AxisListName) or self.eAxisListGrid
        PopupMgr.AddItem('-','Sep:AxisListScale','',-1)
      end
      PopupMgr.AddItem('Scale linear','AxisListScaleLinear','',-1)
      PopupMgr.AddItem('Scale as MS Word','AxisListScaleAsMSWord','',-1)
        case self.eAxisListScale
        of Scale:AsMSWord         ; PopupMgr.SetItemCheck('AxisListScaleAsMSWord',true)
        else
          PopupMgr.SetItemCheck('AxisListScaleLinear',true)
        end
    end
    if band(self.ePopUpItems,GraphPop:AxisListScaleMinMax)
      if locSep or band(self.ePopUpItems,GraphPop:AxisListName) or self.eAxisListGrid or |
         band(self.ePopUpItems,GraphPop:AxisListScale)
        PopupMgr.AddItem('-','Sep:AxisListScaleMinMax','',-1)
      end
      PopupMgr.AddItem('Scale min/max','AxisListScaleMinMax','',-1)
      PopupMgr.SetItemCheck('AxisListScaleMinMax',self.eAxisListScaleMinMax)
      if inlist(self.GraphType(), GraphType:ColumnWithAccumulation, GraphType:BarWithAccumulation)
        PopupMgr.SetItemEnable('AxisListScaleMinMax', false)
      else
        PopupMgr.SetItemEnable('AxisListScaleMinMax', true)
      end
    end
  end
  if band(self.ePopUpItems,GraphPop:Node) or ~self.ePopUpHideItems
    ...
    PopupMgr.SetItemEnable('Node', choose(band(self.ePopUpItems,GraphPop:Node) and |
                                          inlist(self.GraphType(),GraphType:Line,GraphType:ScatterGraph,|
    ...
    if band(self.ePopUpItems,GraphPop:NodeBgr)
  ...
  if band(self.ePopUpItems, GraphPop:Wallpaper) or ~self.ePopUpHideItems
    PopupMgr.AddItem('-','Sep:Wallpaper','',1)
    PopupMgr.AddItem('Wallpaper','Wallpaper','',1)
    PopupMgr.SetItemEnable('Wallpaper', choose(band(self.ePopUpItems, GraphPop:Wallpaper)))
    locSep = self.CalcPopupAdd2(PopupMgr, 'Stretched', 'WallpaperStretched', self.ePopUpSubWallpaper, |
                                GraphPop:Wallpaper:Stretched, self.eWallpaper, Wallpaper:Stretched)
    locSep += self.CalcPopupAdd2(PopupMgr, 'Tiled', 'WallpaperTiled', self.ePopUpSubWallpaper, |
                                GraphPop:Wallpaper:Tiled, self.eWallpaper, Wallpaper:Tiled)
    locSep += self.CalcPopupAdd2(PopupMgr, 'Centered', 'WallpaperCentered', self.ePopUpSubWallpaper, |
                                GraphPop:Wallpaper:Centered, self.eWallpaper, Wallpaper:Centered)
    locSep += self.CalcPopupAdd2(PopupMgr, 'None', 'WallpaperNone', self.ePopUpSubWallpaper, |
                                GraphPop:Wallpaper:None, self.eWallpaper, Wallpaper:None)
  end
...
PopupMgr          PopupClass                        ! declare PopupMgr object
 code
  ...
  of lower('AxisListStylesNone')      ; self.PostEvent(event:AxisListStyle:None)
  of lower('AxisListStylesStandard')  ; self.PostEvent(event:AxisListStyle:Standard)
  of lower('AxisListStylesLong')      ; self.PostEvent(event:AxisListStyle:Long)
  of lower('AxisListScaleLinear')     ; self.PostEvent(event:AxisListScale:Linear)
  of lower('AxisListScaleAsMSWord')   ; self.PostEvent(event:AxisListScale:AsMSWord)
  ...
  of lower('WallpaperNone')           ; self.PostEvent(event:Wallpaper:None)
  of lower('WallpaperStretched')      ; self.PostEvent(event:Wallpaper:Stretched)
  of lower('WallpaperTiled')          ; self.PostEvent(event:Wallpaper:Tiled)
  of lower('WallpaperCentered')       ; self.PostEvent(event:Wallpaper:Centered)
  of lower('Title')
  ...
  of lower('AxisListScaleMinMax')
    self.PostEvent(choose(~PopupMgr.GetItemChecked(PopupString),event:AxisListScaleMinMaxON,event:AxisListScaleMinMaxOFF))
  of lower('AxisListName')
    self.PostEvent(choose(~PopupMgr.GetItemChecked(PopupString),event:AxisListNameON,event:AxisListNameOFF))
  of lower('Gradient')
...
!
! iNode interface
GraphClass.iNode.IsNullPar               procedure(*queue parQ)
 code
  return self.IsNullPar(parQ)
!
...
! iDiagram interface
GraphClass.iDiagram.IsNullPar            procedure(*queue parQ)
 code
  return self.IsNullPar(parQ)
!
...
!
GraphClass.iDiagram.ToW             procedure(real parValue)
 code
  return self.ToW(parValue)
!
GraphClass.iDiagram.ToH             procedure(real parValue)
 code
  return self.ToH(parValue)
!
GraphClass.iDiagram.ToLW            procedure(real parValue)
 code
  return self.ToLW(parValue)
!
...
!
GraphClass.iDiagram.AxisListMinX    procedure
 code
  return self.gAxisMin.eX
!
GraphClass.iDiagram.AxisListMinY    procedure
 code
...
!
GraphClass.iDiagram.ClusterSumNh     procedure(<real parValue>)
 code
  if ~omitted(parValue)
    self.qCluster.eSumNh = parValue
    put(self.qCluster)
    self.ErrCode(errorcode())
  end
  return self.qCluster.eSumNh
!
GraphClass.iDiagram.ClusterSumPh     procedure(<real parValue>)
 code
  if ~omitted(parValue)
    self.qCluster.eSumPh = parValue
    put(self.qCluster)
    self.ErrCode(errorcode())
  end
  return self.qCluster.eSumPh
!
GraphClass.iDiagram.ClusterSumY     procedure
 code
  return (self.qCluster.gSumP.eY + abs(self.qCluster.gSumN.eY)) !self.qCluster.gSum.eY
!
