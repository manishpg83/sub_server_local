  ...
  MAP
GetPageReference  PROCEDURE(STRING Pathname),STRING,PRIVATE
EnsureSeparated   PROCEDURE(STRING),STRING,PRIVATE
RemoveDirectory   PROCEDURE(STRING Filename),PRIVATE
StripSeparator    PROCEDURE(STRING),STRING,PRIVATE
  END
