...
Looped BYTE
  ...
  LOOP                                                     ! This method receive all EVENT:Accepted's
    ...
    OF ?BUTTON_ExportIgG
      ...
      URLHandler(QuickWindow{prop:handle},'https://amxemr.com/cpl/normals.php?type=2' )
  ...
  ReturnValue = PARENT.TakeAccepted()
    ...
    OF ?BUTTON_ExportE
      ...
      CLOSE(Post)
      RUN('CMD /c ECHO ON & pscp -v -p -pw xD1GkuK7a7DK8! ' & CLIP(gloFileName2) & 'amx@amxemr.com:/home/amx/public_html/cpl & EXIT',0)   
      URLHandler(QuickWindow{prop:handle},'https://amxemr.com/cpl/normals.php?type=1' )
    OF ?BUTTON_ExportIgG4
      ...
      CLOSE(Post)
      RUN('CMD /c ECHO ON & pscp -v -p -pw xD1GkuK7a7DK8! ' & CLIP(gloFileName2) & 'amx@amxemr.com:/home/amx/public_html/cpl & EXIT',0)   
      URLHandler(QuickWindow{prop:handle},'https://amxemr.com/cpl/normals.php?type=3' )
    OF ?OK
      ThisWindow.Update
