...
if ($sub == 0){
  ...
  if ($pass === true) {
    ...
    $link = "https://dev.amxemr.com/logout.php";
  ...
  if ($id < 100000){include('/home/amx/public_html/new.php');exit;}
...
<div id="frmtop">
<form action="logout.php"><input id="lo" type="submit" value="Cerrar sesión" /></form>
</div>
<div id="frmbot"><div id="inp">
<form action="#" method="post">
<div class="box"><h3>Buscar pacientes por:</h3>
<p class="label">ID del paciente</p>
<input id="code" name="code" value="" type="search" />
<p class="label">&#x2002;<br/>Apellido del paciente</p>
<input id="name" name="name" value="" type="search" />
<p class="label">&#x2002;<br/>Número de días hábiles</p>
<input type="number" id="daysValue" min="1" size="2" name="d" value="$days" />
&#x2002;( 5 días / semana)</div>
<div class="box"><h3>Ordenar por:</h3>
<div id="d1"  class="divNoCheck" ><input id="c1" class="noCheck" type="radio" name="s" value="1"  onclick="radio(1,1,5)"  $chkSort[1]  />&#x2002;Nombre del paciente</div>
<div id="d2"  class="divNoCheck" ><input id="c2" class="noCheck" type="radio" name="s" value="2"  onclick="radio(2,1,5)"  $chkSort[2]  />&#x2002;Fecha</div>
<div id="d3"  class="divNoCheck" ><input id="c3" class="noCheck" type="radio" name="s" value="3"  onclick="radio(3,1,5)"  $chkSort[3]  />&#x2002;Estado</div>
<div id="d4"  class="divNoCheck" ><input id="c4" class="noCheck" type="radio" name="s" value="4"  onclick="radio(4,1,5)"  $chkSort[4]  />&#x2002;ID de laboratorio</div>
<div id="d5"  class="divNoCheck" ><input id="c5" class="noCheck" type="radio" name="s" value="5"  onclick="radio(5,1,5)"  $chkSort[5]  />&#x2002;ID del paciente</div>
</div>
<div class="box"><h3>Mostrar lo siguiente:</h3>
<div id="d6"  class="divNoCheck" ><input id="c6" class="noCheck" type="checkbox" name="xR" onclick="check(6)"  $chkStatus[1]  />&#x2002;Recibido</div>
<div id="d7"  class="divNoCheck" ><input id="c7" class="noCheck" type="checkbox" name="xT" onclick="check(7)"  $chkStatus[2]  />&#x2002;En pruebas</div>
<div id="d8"  class="divNoCheck" ><input id="c8" class="noCheck" type="checkbox" name="xC" onclick="check(8)"  $chkStatus[3]  />&#x2002;Terminado</div>
</div>
<input id="sub" type="submit" value="Buscar" /></div>
<input type="hidden" name="sub" value="1" />
</form>
$clear<button id="ss" type="button"  onclick="showSearch()" >Mostrar búsqueda</button>
EOT;
flush();
...
$sort = $sort[$sortVal];
$hid[0] = '<tr><td><button class="h1"  type="button" name="sn1" onclick="stNum(1)" >Nombre</button></td><td><button class="h3"  type="button" name="sn3" onclick="stNum(3)" >ID de laboratorio</button></td><td><button class="h4"  type="button" name="sn4" onclick="stNum(4)" >Fecha</button></td><td><button class="h5"  type="button" name="sn5" onclick="stNum(5)" >Estado</button></td><td class="h6"><button class="h6" type="button" name="sn7" >Hecho</button></td></tr>';
$hid[1] = '<tr><td><button class="h1"  type="button" name="sn1" onclick="stNum(1)" >Nombre</button></td><td><button class="h2"  type="button" name="sn2" onclick="stNum(2)" >ID del paciente</button></td><td><button class="h3"  type="button" name="sn3" onclick="stNum(3)" >ID de laboratorio</button></td><td><button class="h4"  type="button" name="sn4" onclick="stNum(4)" >Fecha</button></td><td><button class="h5"  type="button" name="sn5" onclick="stNum(5)" >Estado</button></td><td><button class="h6" type="button" name="sn7" >Hecho</button></td></tr>';
$pdf['V'][1] = '<td><button class="v5"  type="button">Recibido';
$pdf['L'][1] = '<td><button class="v5"  type="button">Recibido';
$pdf['W'][1] = '<td><button class="w5"  type="button">En pruebas: ';
...
$pdf['C'][1] = '<td><form action="https://dev.amxemr.com/pdf.php" method="get" target="_blank"><button class="c5"  type="submit">Terminado ( PDF )</button><input type="hidden" name="p" value="';
$pdf['V'][2] = '</button></td>';
$pdf['L'][2] = '</button></td>';
$pdf['Q'][2] = '</button></td>';
$pdf['X'][2] = '</button></td>';
...
//	$age = date_diff(date_create($row[9]), date_create('today'))->y;
    ...
    echo <<<EOT
<tr>
<td><form action="es.php" method="post"><input type="hidden" name="sub" value="4" /><input type="hidden" name="name" value="$row[6]" /><button class="c1"  type="submit">$row[6], $row[7]</button></form></td>
$idRow[$cid]
