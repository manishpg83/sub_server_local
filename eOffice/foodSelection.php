...
<!DOCTYPE html><html lang="en"><head><title>Allermetrix eOffice</title><style>

body { font-family : arial; border : 0; padding : 0; margin : 0; background:#f7f7fb;} 
#logo { margin : 0 auto 0; }
#content { max-width : 480px; margin : 0 auto 0; padding :0; }
#col1, #col2, #col3 { float : left; width : 300px; }
#col2, #col3 {
margin-left : 2em; }
.columns2{margin:0 0 .3em .3em;padding-top:1em;column-count: 2;} 
#footer { text-align : center; padding-top : 8em; clear : left; } #menu { display : inline-block;} 
.btnx { margin : 1em 0 0 2em; width : 200px; padding : 5px 2em 5px 2em; border-radius : 3px 3px 3px 3px; box-shadow : 0 2px 5px #999; font : 700 1em Arial, Helvetica, Calibri, sans-serif; overflow : visible; border : #69B5B3 solid 1px; color : #fff; background-color : #144; background-image : linear-gradient(to bottom, rgb(0, 0, 255, 1) 0%, rgb(0, 0, 64, 1) 100%); }
#copyright { padding-top : 1.5em; font-size : 0.8em; }
.white { color : #fff; }
.bold { font-weight : bolder; color : #00515a; font-size : 1em;
margin-bottom : 10px; }
...
.hide { display : none; }
.red { color : red; font : 700 1.2em Arial; }
.big { font-size : 1.3em; }
...
.dchk{width:100%;font:700 1em Arial,sans-serif;color:#fff;display:inline-block;padding:2px 0 2px 2px;margin:0 0 .2em;vertical-align: middle;position: relative;}
.link{border:1px solid #69B5B3;color: #fff;background-color:#fff;background: linear-gradient(to bottom, #2ef 0%, #02f 100%);
width:100%;padding:0.5em;margin:.3em 0 0 0;border-radius: 3px 3px 3px 3px;font: 700 1em Arial,sans-serif;overflow: visible;}
...
#autofill { font-size : 0.8em; }
#s13{padding:1em 0 0 .5em;}
#next{width:100%;padding:10px;margin-top:12px;font-size:1.2em;}
p{margin:5px 0 5px 1em;line-height:1.5;font-size:0.9em;}
...
<button id="b13" class="link" type="button" onclick ="exp('13')">Patient Instructions:</button>
<div id="s13">
...
<p>&bull; Studies indicate you are most likely allergic to foods you eat often.</p>
<p>&bull; When finished, select the "Next" button.<br></p>
</div>
<p class="bold center red">Check ONLY foods you eat<br>AT LEAST THREE TIMES per week.</p>

<button id="b2" class="link" type="button" onclick ="exp('2')">Eggs and Dairy</button>
<div id="s2" class="columns2">
...
<button id="b1" class="link" type="button" onclick ="exp('1')">Meat</button>
...
<button id="b3" class="link" type="button" onclick ="exp('3')">Fish</button>
<div id="s3" class="columns2">
...
<button id="b9" class="link" type="button" onclick ="exp('9')">Shellfish</button><div id="s9" class="columns2">
...
<button id="b7" class="link" type="button" onclick ="exp('7')">Peas, Beans, &amp; Legumes</button>
<div id="s7" class="columns2">
...
<button id="b12" class="link" type="button" onclick ="exp('12')">Vegatables</button><div id="s12" class="columns2">
...
<button id="b5" class="link" type="button" onclick ="exp('5')">Bread, Cereal, Rice, &amp; Grains</button>
<div id="s5" class="columns2">
...
<button id="b4" class="link" type="button" onclick ="exp('4')">Fruit</button><div id="s4" class="columns2">
...
<button id="b11" class="link" type="button" onclick ="exp('11')"> Nuts</button>
<div id="s11" class="columns2">
...
<button id="b8" class="link" type="button" onclick ="exp('8')">Seeds, Spices &amp; Peppers</button>
<div id="s8" class="columns2">
...
<button id="b10" class="link" type="button" onclick ="exp('10')">Sugar</button>
<div id="s10" class="columns2">
...
<button id="b6" class="link" type="button" onclick ="exp('6')">Yeast</button>
<div id="s6" class="columns2">
...
<input id="next" type="submit" value="Next" class="link" />
</form>
...
bg[true] = '#f00';
bg[false] = '#2985EA';
var expButtons = {1:[null,null], 2:[null,null], 3:[null,null], 4:[null,null], 5:[null,null], 6:[null,null], 7:[null,null], 8:[null,null], 9:[null,null], 10:[null,null], 11:[null,null],12:[null,null],13:[null,null]};
...
function exp(id){
  var e = expButtons[id][0].style.display;
  expButtons[prev][0].style.display='none';
  expButtons[id][0].style.display=flip[e];
  prev=id;
}
...
expButtons[13][0].style.display = 'block';
