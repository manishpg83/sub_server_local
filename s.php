...
if ($id < 100000){include('/home/amx/public_html/index.php');return;}
$name = $_POST['name'];
$code= $_POST['code'];
$days = $_POST['days'];
$daysOn = $_POST['daysOn'];
...
form{display:inline;}
.dieticon{background-image: url('data:image/gif;base64,');}
</style>
...
if ($d < mktime(0, 0, 0, 7, 27, 2009) || $call == true) {
  $call = false;
 echo '<div class="dieticon"></div><a class="row4a"data-icon="alert" data-role="button" data-inline="true"   >Call Allermetrix</a>';
}
else {
