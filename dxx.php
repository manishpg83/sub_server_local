...
if($_GET['p'] == 100005){$client= 888887; $patient = 100005;$_POST['sub'] = 1;}
echo <<<EOT
...
if (strlen($client) == 6 AND strlen($patient) == 6){
  ...
  while ($fd = mysqli_fetch_array($results, MYSQLI_NUM)){
    ...
    $grp = intval($fd[2]);
    $day = intval($fd[3]);
    $foods[$fd[5]] = array($fd[1],0,0,0,0,0,$grp,$day,$fd[4],$fd[0],'','','',0);
...
<div id="d13" class="divNoCheck" ><input id="c13"  class="noCheck" type="radio" name="R2" value="4"  onclick="radio(13,10,13)"  $cutOff[4] disabled="diabled" />&#160;&#160;3&#x2003;</div>
...
<div id="d17" class="divNoCheck" ><input id="c17"  class="noCheck" type="radio" name="R1" value="4"  onclick="radio(17,14,17)"  $cutOffG[4] disabled="diabled" />&#160;&#160;3&#x2003;</div>
