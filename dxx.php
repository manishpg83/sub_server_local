...
echo '<div><a href="https://www.mozilla.org/en-US/firefox/new/"><img width="96" height=96" src="https://amxemr.com/ff.png" /></a><h3>WARNING:  FireFox Browser is required to print Diet Plan.</h3></div>';
}
echo <<<EOT
